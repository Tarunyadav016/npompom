...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7366627166:AAFFj0lHgPjxtTFI8WXRoCrfiU_lQAlCGNI")
...
HOW_TO_WATCH_LINK = os.environ.get("HOW_TO_WATCH_LINK", "https://t.me/how_bot_work/19")
