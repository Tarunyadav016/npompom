...
# Bot token @Botfather
BOT_TOKEN = os.environ.get("BOT_TOKEN", "7366627166:AAFTSpDrvBcfxONsOl6YXif1Zp0eyBrAV18")
...
HOW_TO_WATCH_LINK = os.environ.get("HOW_TO_WATCH_LINK", "https://t.me/how_bot_work/12")
